...
public class DefaultIndex {
  ...
  public DefaultIndex(InputComponentStore componentStore, InputComponentTree tree, InputModuleHierarchy moduleHierarchy, MeasureCache measureCache, MetricFinder metricFinder) {
  ...
  public Resource toResource(InputComponent inputComponent) {
    ...
    if (inputComponent instanceof InputDir) {
      ...
      r = new Project((DefaultInputModule) inputComponent, moduleHierarchy);
    } else {
