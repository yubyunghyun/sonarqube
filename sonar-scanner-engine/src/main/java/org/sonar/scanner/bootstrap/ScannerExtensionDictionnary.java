...
public class ScannerExtensionDictionnary {
  ...
  public ScannerExtensionDictionnary(InputModuleHierarchy moduleHierarchy, ComponentContainer componentContainer, DefaultSensorContext sensorContext,
  ...
  private boolean shouldKeep(Class type, Object extension, @Nullable DefaultInputModule module, @Nullable ExtensionMatcher matcher) {
    ...
    if (keep && module != null && ClassUtils.isAssignable(extension.getClass(), CheckProject.class)) {
      keep = ((CheckProject) extension).shouldExecuteOnProject(new Project(module, moduleHierarchy));
    }
    return keep;
  }
}
